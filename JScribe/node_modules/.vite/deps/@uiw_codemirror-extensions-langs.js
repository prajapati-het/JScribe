...
import {
  vue
} from "./chunk-VUASEWVP.js";
import {
  angular
} from "./chunk-TY46BCK7.js";
import {
  webIDL
...
import {
  textile
} from "./chunk-T63OYTGG.js";
import {
  tiddlyWiki
} from "./chunk-2O2ZZDRO.js";
import {
  tiki
...
import {
  solr
} from "./chunk-W6TBOTED.js";
import {
  sparql
} from "./chunk-N33G7744.js";
import {
  spreadsheet
...
import {
  stex
} from "./chunk-OS5WPQ6U.js";
import {
  verilog
} from "./chunk-Z4H4AK74.js";
import {
  tcl
} from "./chunk-OFVMQAQ5.js";
import {
  r
} from "./chunk-G4U2NW2X.js";
import {
  ruby
...
import {
  shell
} from "./chunk-EKW6VLRN.js";
import {
  sieve
} from "./chunk-EF6V2W35.js";
import {
  smalltalk
} from "./chunk-JN2FWW6I.js";
import {
  perl
} from "./chunk-Q67PCX3Q.js";
import {
  pig
} from "./chunk-A6PMDH2Y.js";
import {
  powerShell
...
import {
  puppet
} from "./chunk-A7PLKVG7.js";
import {
  q
} from "./chunk-3T5PKFY6.js";
import {
  mumps
} from "./chunk-PAOYFHUW.js";
import {
  mbox
} from "./chunk-VZQGXX46.js";
import {
  nginx
...
import {
  octave
} from "./chunk-YSRUOGBC.js";
import {
  oz
} from "./chunk-BH46VEDO.js";
import {
  pascal
} from "./chunk-PRIFVFAS.js";
import {
  jinja2
} from "./chunk-4HZ274BE.js";
import {
  julia
...
import {
  mirc
} from "./chunk-7XE2E7HZ.js";
import {
  mathematica
} from "./chunk-VBASCVTS.js";
import {
  modelica
} from "./chunk-4BTYERAT.js";
import {
  gas
} from "./chunk-DZEGTK55.js";
import {
  gherkin
...
import {
  haxe
} from "./chunk-BLDU7GWP.js";
import {
  http
} from "./chunk-4IFM6N6O.js";
import {
  idl
} from "./chunk-XBQW6AM5.js";
import {
  eiffel
} from "./chunk-3TE7BGU5.js";
import {
  elm
} from "./chunk-MIERGWNR.js";
import {
  erlang
...
import {
  fcl
} from "./chunk-Z355IY47.js";
import {
  forth
} from "./chunk-G34BALKX.js";
import {
  fortran
} from "./chunk-IWICDRP3.js";
import {
  crystal
} from "./chunk-44DZRZ4C.js";
import {
  d
} from "./chunk-CVT27DCA.js";
import {
  diff
...
import {
  dylan
} from "./chunk-HGCUIACP.js";
import {
  ebnf
} from "./chunk-BOLSYY7E.js";
import {
  ecl
} from "./chunk-KHHTEHKN.js";
import {
  c,
  ceylon,
  dart,
...
import {
  commonLisp
} from "./chunk-7MGBLYQP.js";
import {
  cypher
} from "./chunk-U53PSU5Y.js";
import {
  xml
...
import {
  asterisk
} from "./chunk-C46OLGFD.js";
import {
  brainfuck
} from "./chunk-5Y56YTL6.js";
import {
  cobol
} from "./chunk-JJBAHWUF.js";
import {
  less
} from "./chunk-UAMJFO3O.js";
import {
  liquid
} from "./chunk-I26VZKY7.js";
import {
  markdown,
  markdownLanguage
} from "./chunk-7KDK2422.js";
import {
  php
} from "./chunk-3X7QKMSG.js";
import {
  python
...
import {
  ...
  ExternalTokenizer,
  LRParser
} from "./chunk-Y45PWBWM.js";
import {
  completeFromList,
  ifNotIn,
  snippetCompletion
} from "./chunk-BHZRJYTL.js";
import {
  EditorSelection,
  EditorView,
  LRLanguage,
...
function sql2(dialectName) {
  return import("./dist-BK4RJKIJ.js").then((m) => m.sql({ dialect: m[dialectName] }));
}
var languages = [
  ...
  LanguageDescription.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./dist-V2N37ZEQ.js").then((m) => m.cpp());
    }
  }),
  LanguageDescription.of({
    name: "C++",
  ...
  LanguageDescription.of({
    ...
    extensions: ["css"],
    load() {
      return import("./dist-PEVD4NPT.js").then((m) => m.css());
    }
  }),
  LanguageDescription.of({
    name: "Go",
    extensions: ["go"],
    load() {
      return import("./dist-X4PUZ3WT.js").then((m) => m.go());
    }
  }),
  LanguageDescription.of({
    name: "HTML",
    ...
    load() {
      return import("./dist-2ZXLL3KE.js").then((m) => m.html());
    }
  }),
  LanguageDescription.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./dist-CX7K55GQ.js").then((m) => m.java());
    }
  }),
  LanguageDescription.of({
    name: "JavaScript",
    ...
    load() {
      return import("./dist-RL2Q25JR.js").then((m) => m.javascript());
    }
  }),
  LanguageDescription.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./dist-PBZ56NQ3.js").then((m) => m.json());
    }
  }),
  LanguageDescription.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./dist-RL2Q25JR.js").then((m) => m.javascript({ jsx: true }));
    }
  }),
  LanguageDescription.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./dist-3JQARMA5.js").then((m) => m.less());
    }
  }),
  LanguageDescription.of({
    name: "Liquid",
    extensions: ["liquid"],
    load() {
      return import("./dist-U3GGZYFM.js").then((m) => m.liquid());
    }
  }),
  LanguageDescription.of({
    name: "MariaDB SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-LF222C7I.js").then((m) => m.markdown());
    }
  }),
  LanguageDescription.of({
    name: "MS SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-HSXIMYNT.js").then((m) => m.php());
    }
  }),
  LanguageDescription.of({
    name: "PLSQL",
  ...
  LanguageDescription.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./dist-KQHCHQGZ.js").then((m) => m.python());
    }
  }),
  LanguageDescription.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./dist-RHY37V7D.js").then((m) => m.rust());
    }
  }),
  LanguageDescription.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./dist-UKAE3A76.js").then((m) => m.sass({ indented: true }));
    }
  }),
  LanguageDescription.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./dist-UKAE3A76.js").then((m) => m.sass());
    }
  }),
  LanguageDescription.of({
    name: "SQL",
  ...
  LanguageDescription.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./dist-RL2Q25JR.js").then((m) => m.javascript({ jsx: true, typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "TypeScript",
    ...
    load() {
      return import("./dist-RL2Q25JR.js").then((m) => m.javascript({ typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./dist-7O5WHAAZ.js").then((m) => m.wast());
    }
  }),
  LanguageDescription.of({
    name: "XML",
    ...
    load() {
      return import("./dist-IXP4NKM2.js").then((m) => m.xml());
    }
  }),
  LanguageDescription.of({
    name: "YAML",
    ...
    extensions: ["yaml", "yml"],
    load() {
      return import("./dist-J3RDFOFK.js").then((m) => m.yaml());
    }
  }),
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./apl-RG3GIBAY.js").then((m) => legacy(m.apl));
    }
  }),
  LanguageDescription.of({
    name: "PGP",
    ...
    load() {
      return import("./asciiarmor-ANLHZKZM.js").then((m) => legacy(m.asciiArmor));
    }
  }),
  LanguageDescription.of({
    name: "ASN.1",
    extensions: ["asn", "asn1"],
    load() {
      return import("./asn1-RUIC57AS.js").then((m) => legacy(m.asn1({})));
    }
  }),
  LanguageDescription.of({
    name: "Asterisk",
    ...
    load() {
      return import("./asterisk-SXPVUYX2.js").then((m) => legacy(m.asterisk));
    }
  }),
  LanguageDescription.of({
    name: "Brainfuck",
    extensions: ["b", "bf"],
    load() {
      return import("./brainfuck-ZKZYO62T.js").then((m) => legacy(m.brainfuck));
    }
  }),
  LanguageDescription.of({
    name: "Cobol",
    extensions: ["cob", "cpy"],
    load() {
      return import("./cobol-S7EHN2H2.js").then((m) => legacy(m.cobol));
    }
  }),
  LanguageDescription.of({
    name: "C#",
    ...
    extensions: ["cs"],
    load() {
      return import("./clike-IKVNSMZJ.js").then((m) => legacy(m.csharp));
    }
  }),
  LanguageDescription.of({
    name: "Clojure",
    ...
    load() {
      return import("./clojure-V3R426SU.js").then((m) => legacy(m.clojure));
    }
  }),
  LanguageDescription.of({
    name: "ClojureScript",
  ...
  LanguageDescription.of({
    ...
    extensions: ["gss"],
    load() {
      return import("./css-PA2VVGTJ.js").then((m) => legacy(m.gss));
    }
  }),
  LanguageDescription.of({
    name: "CMake",
    ...
    load() {
      return import("./cmake-3OCFVHOQ.js").then((m) => legacy(m.cmake));
    }
  }),
  LanguageDescription.of({
    name: "CoffeeScript",
    ...
    extensions: ["coffee"],
    load() {
      return import("./coffeescript-Z52HFCKE.js").then((m) => legacy(m.coffeeScript));
    }
  }),
  LanguageDescription.of({
    name: "Common Lisp",
    ...
    load() {
      return import("./commonlisp-U7MBZLGS.js").then((m) => legacy(m.commonLisp));
    }
  }),
  LanguageDescription.of({
    name: "Cypher",
    ...
    load() {
      return import("./cypher-ZVMYYDQ5.js").then((m) => legacy(m.cypher));
    }
  }),
  LanguageDescription.of({
    name: "Cython",
    ...
    load() {
      return import("./python-53EJAPBL.js").then((m) => legacy(m.cython));
    }
  }),
  LanguageDescription.of({
    name: "Crystal",
    extensions: ["cr"],
    load() {
      return import("./crystal-URQG27JH.js").then((m) => legacy(m.crystal));
    }
  }),
  LanguageDescription.of({
    name: "D",
    extensions: ["d"],
    load() {
      return import("./d-V3GFXKYM.js").then((m) => legacy(m.d));
    }
  }),
  LanguageDescription.of({
    name: "Dart",
    extensions: ["dart"],
    load() {
      return import("./clike-IKVNSMZJ.js").then((m) => legacy(m.dart));
    }
  }),
  LanguageDescription.of({
    name: "diff",
    ...
    load() {
      return import("./diff-DYUBKHQO.js").then((m) => legacy(m.diff));
    }
  }),
  LanguageDescription.of({
    name: "Dockerfile",
    filename: /^Dockerfile$/,
    load() {
      return import("./dockerfile-DCA2SJ3K.js").then((m) => legacy(m.dockerFile));
    }
  }),
  LanguageDescription.of({
    name: "DTD",
    extensions: ["dtd"],
    load() {
      return import("./dtd-K7IKVDD3.js").then((m) => legacy(m.dtd));
    }
  }),
  LanguageDescription.of({
    name: "Dylan",
    ...
    load() {
      return import("./dylan-FEQZHQFD.js").then((m) => legacy(m.dylan));
    }
  }),
  LanguageDescription.of({
    name: "EBNF",
    load() {
      return import("./ebnf-N6SHR4KC.js").then((m) => legacy(m.ebnf));
    }
  }),
  LanguageDescription.of({
    name: "ECL",
    extensions: ["ecl"],
    load() {
      return import("./ecl-DKXAVBUS.js").then((m) => legacy(m.ecl));
    }
  }),
  LanguageDescription.of({
    name: "edn",
  ...
  LanguageDescription.of({
    ...
    extensions: ["e"],
    load() {
      return import("./eiffel-7QIKKOME.js").then((m) => legacy(m.eiffel));
    }
  }),
  LanguageDescription.of({
    name: "Elm",
    extensions: ["elm"],
    load() {
      return import("./elm-5QOFTJYW.js").then((m) => legacy(m.elm));
    }
  }),
  LanguageDescription.of({
    name: "Erlang",
    extensions: ["erl"],
    load() {
      return import("./erlang-4AJAIOZ3.js").then((m) => legacy(m.erlang));
    }
  }),
  LanguageDescription.of({
    name: "Esper",
    load() {
      return import("./sql-KUPOTQNI.js").then((m) => legacy(m.esper));
    }
  }),
  LanguageDescription.of({
    name: "Factor",
    extensions: ["factor"],
    load() {
      return import("./factor-XHFFQU7W.js").then((m) => legacy(m.factor));
    }
  }),
  LanguageDescription.of({
    name: "FCL",
    load() {
      return import("./fcl-I7OCRRLK.js").then((m) => legacy(m.fcl));
    }
  }),
  LanguageDescription.of({
    name: "Forth",
    ...
    load() {
      return import("./forth-3JR37ACM.js").then((m) => legacy(m.forth));
    }
  }),
  LanguageDescription.of({
    name: "Fortran",
    ...
    load() {
      return import("./fortran-SHZFP7K2.js").then((m) => legacy(m.fortran));
    }
  }),
  LanguageDescription.of({
    name: "F#",
    ...
    extensions: ["fs"],
    load() {
      return import("./mllike-X4JYTZS7.js").then((m) => legacy(m.fSharp));
    }
  }),
  LanguageDescription.of({
    name: "Gas",
    extensions: ["s"],
    load() {
      return import("./gas-UUJA7ZO6.js").then((m) => legacy(m.gas));
    }
  }),
  LanguageDescription.of({
    name: "Gherkin",
    extensions: ["feature"],
    load() {
      return import("./gherkin-QDSNQOFR.js").then((m) => legacy(m.gherkin));
    }
  }),
  LanguageDescription.of({
    name: "Groovy",
    ...
    load() {
      return import("./groovy-4JHQOUUT.js").then((m) => legacy(m.groovy));
    }
  }),
  LanguageDescription.of({
    name: "Haskell",
    extensions: ["hs"],
    load() {
      return import("./haskell-LNWXSHUH.js").then((m) => legacy(m.haskell));
    }
  }),
  LanguageDescription.of({
    name: "Haxe",
    extensions: ["hx"],
    load() {
      return import("./haxe-DZIKRKTA.js").then((m) => legacy(m.haxe));
    }
  }),
  LanguageDescription.of({
    name: "HXML",
    extensions: ["hxml"],
    load() {
      return import("./haxe-DZIKRKTA.js").then((m) => legacy(m.hxml));
    }
  }),
  LanguageDescription.of({
    name: "HTTP",
    load() {
      return import("./http-I3UF5AO6.js").then((m) => legacy(m.http));
    }
  }),
  LanguageDescription.of({
    name: "IDL",
    extensions: ["pro"],
    load() {
      return import("./idl-FQY4YZJN.js").then((m) => legacy(m.idl));
    }
  }),
  LanguageDescription.of({
    name: "JSON-LD",
    ...
    extensions: ["jsonld"],
    load() {
      return import("./javascript-BI2YG52N.js").then((m) => legacy(m.jsonld));
    }
  }),
  LanguageDescription.of({
    name: "Jinja2",
    ...
    load() {
      return import("./jinja2-YER4ZTHD.js").then((m) => legacy(m.jinja2));
    }
  }),
  LanguageDescription.of({
    name: "Julia",
    extensions: ["jl"],
    load() {
      return import("./julia-S4X6HYGR.js").then((m) => legacy(m.julia));
    }
  }),
  LanguageDescription.of({
    name: "Kotlin",
    extensions: ["kt", "kts"],
    load() {
      return import("./clike-IKVNSMZJ.js").then((m) => legacy(m.kotlin));
    }
  }),
  LanguageDescription.of({
    name: "LiveScript",
    ...
    extensions: ["ls"],
    load() {
      return import("./livescript-5BMDSO7S.js").then((m) => legacy(m.liveScript));
    }
  }),
  LanguageDescription.of({
    name: "Lua",
    extensions: ["lua"],
    load() {
      return import("./lua-R72P2RE2.js").then((m) => legacy(m.lua));
    }
  }),
  LanguageDescription.of({
    name: "mIRC",
    extensions: ["mrc"],
    load() {
      return import("./mirc-6B7SADN5.js").then((m) => legacy(m.mirc));
    }
  }),
  LanguageDescription.of({
    name: "Mathematica",
    ...
    load() {
      return import("./mathematica-R6WHEZEP.js").then((m) => legacy(m.mathematica));
    }
  }),
  LanguageDescription.of({
    name: "Modelica",
    extensions: ["mo"],
    load() {
      return import("./modelica-WMKOQOAJ.js").then((m) => legacy(m.modelica));
    }
  }),
  LanguageDescription.of({
    name: "MUMPS",
    extensions: ["mps"],
    load() {
      return import("./mumps-Y3VT3TW3.js").then((m) => legacy(m.mumps));
    }
  }),
  LanguageDescription.of({
    name: "Mbox",
    extensions: ["mbox"],
    load() {
      return import("./mbox-OLVCUPTN.js").then((m) => legacy(m.mbox));
    }
  }),
  LanguageDescription.of({
    name: "Nginx",
    ...
    load() {
      return import("./nginx-2GGGC3Q5.js").then((m) => legacy(m.nginx));
    }
  }),
  LanguageDescription.of({
    name: "NSIS",
    extensions: ["nsh", "nsi"],
    load() {
      return import("./nsis-TBNIH2KZ.js").then((m) => legacy(m.nsis));
    }
  }),
  LanguageDescription.of({
    name: "NTriples",
    extensions: ["nt", "nq"],
    load() {
      return import("./ntriples-HIRX7QDJ.js").then((m) => legacy(m.ntriples));
    }
  }),
  LanguageDescription.of({
    name: "Objective-C",
    ...
    extensions: ["m"],
    load() {
      return import("./clike-IKVNSMZJ.js").then((m) => legacy(m.objectiveC));
    }
  }),
  LanguageDescription.of({
    name: "Objective-C++",
    ...
    extensions: ["mm"],
    load() {
      return import("./clike-IKVNSMZJ.js").then((m) => legacy(m.objectiveCpp));
    }
  }),
  LanguageDescription.of({
    name: "OCaml",
    ...
    load() {
      return import("./mllike-X4JYTZS7.js").then((m) => legacy(m.oCaml));
    }
  }),
  LanguageDescription.of({
    name: "Octave",
    extensions: ["m"],
    load() {
      return import("./octave-KQKHHT7O.js").then((m) => legacy(m.octave));
    }
  }),
  LanguageDescription.of({
    name: "Oz",
    extensions: ["oz"],
    load() {
      return import("./oz-2O7SSBBZ.js").then((m) => legacy(m.oz));
    }
  }),
  LanguageDescription.of({
    name: "Pascal",
    extensions: ["p", "pas"],
    load() {
      return import("./pascal-2TLKQ4JQ.js").then((m) => legacy(m.pascal));
    }
  }),
  LanguageDescription.of({
    name: "Perl",
    extensions: ["pl", "pm"],
    load() {
      return import("./perl-WCGDDUZA.js").then((m) => legacy(m.perl));
    }
  }),
  LanguageDescription.of({
    name: "Pig",
    extensions: ["pig"],
    load() {
      return import("./pig-R6PNDYEX.js").then((m) => legacy(m.pig));
    }
  }),
  LanguageDescription.of({
    name: "PowerShell",
    ...
    load() {
      return import("./powershell-22QQ6ZTY.js").then((m) => legacy(m.powerShell));
    }
  }),
  LanguageDescription.of({
    ...
    load() {
      return import("./properties-MYFDLYPX.js").then((m) => legacy(m.properties));
    }
  }),
  LanguageDescription.of({
    name: "ProtoBuf",
    extensions: ["proto"],
    load() {
      return import("./protobuf-NYGANSGY.js").then((m) => legacy(m.protobuf));
    }
  }),
  LanguageDescription.of({
    name: "Pug",
    ...
    extensions: ["pug", "jade"],
    load() {
      return import("./pug-UKADY4L4.js").then((m) => legacy(m.pug));
    }
  }),
  LanguageDescription.of({
    name: "Puppet",
    extensions: ["pp"],
    load() {
      return import("./puppet-6JH3W5HX.js").then((m) => legacy(m.puppet));
    }
  }),
  LanguageDescription.of({
    name: "Q",
    extensions: ["q"],
    load() {
      return import("./q-BFME4TYT.js").then((m) => legacy(m.q));
    }
  }),
  LanguageDescription.of({
    name: "R",
    ...
    extensions: ["r", "R"],
    load() {
      return import("./r-Y5D2PJI2.js").then((m) => legacy(m.r));
    }
  }),
  LanguageDescription.of({
    name: "RPM Changes",
    load() {
      return import("./rpm-OXVYJZIV.js").then((m) => legacy(m.rpmChanges));
    }
  }),
  LanguageDescription.of({
    name: "RPM Spec",
    extensions: ["spec"],
    load() {
      return import("./rpm-OXVYJZIV.js").then((m) => legacy(m.rpmSpec));
    }
  }),
  LanguageDescription.of({
    name: "Ruby",
    ...
    load() {
      return import("./ruby-AKAZJBHS.js").then((m) => legacy(m.ruby));
    }
  }),
  LanguageDescription.of({
    name: "SAS",
    extensions: ["sas"],
    load() {
      return import("./sas-5K4YS74C.js").then((m) => legacy(m.sas));
    }
  }),
  LanguageDescription.of({
    name: "Scala",
    extensions: ["scala"],
    load() {
      return import("./clike-IKVNSMZJ.js").then((m) => legacy(m.scala));
    }
  }),
  LanguageDescription.of({
    name: "Scheme",
    extensions: ["scm", "ss"],
    load() {
      return import("./scheme-Z2Z67RS6.js").then((m) => legacy(m.scheme));
    }
  }),
  LanguageDescription.of({
    name: "Shell",
    ...
    filename: /^PKGBUILD$/,
    load() {
      return import("./shell-ULANHHEG.js").then((m) => legacy(m.shell));
    }
  }),
  LanguageDescription.of({
    name: "Sieve",
    ...
    load() {
      return import("./sieve-7ZRHX3H6.js").then((m) => legacy(m.sieve));
    }
  }),
  LanguageDescription.of({
    name: "Smalltalk",
    extensions: ["st"],
    load() {
      return import("./smalltalk-V6XB72HW.js").then((m) => legacy(m.smalltalk));
    }
  }),
  LanguageDescription.of({
    name: "Solr",
    load() {
      return import("./solr-YBNLBNTG.js").then((m) => legacy(m.solr));
    }
  }),
  LanguageDescription.of({
    name: "SML",
    ...
    load() {
      return import("./mllike-X4JYTZS7.js").then((m) => legacy(m.sml));
    }
  }),
  LanguageDescription.of({
    name: "SPARQL",
    ...
    load() {
      return import("./sparql-U5RPUN7T.js").then((m) => legacy(m.sparql));
    }
  }),
  LanguageDescription.of({
    name: "Spreadsheet",
    alias: ["excel", "formula"],
    load() {
      return import("./spreadsheet-NWBSQ3UT.js").then((m) => legacy(m.spreadsheet));
    }
  }),
  LanguageDescription.of({
    name: "Squirrel",
    extensions: ["nut"],
    load() {
      return import("./clike-IKVNSMZJ.js").then((m) => legacy(m.squirrel));
    }
  }),
  LanguageDescription.of({
    name: "Stylus",
    extensions: ["styl"],
    load() {
      return import("./stylus-KHOMLZMU.js").then((m) => legacy(m.stylus));
    }
  }),
  LanguageDescription.of({
    name: "Swift",
    extensions: ["swift"],
    load() {
      return import("./swift-QQP3H5KB.js").then((m) => legacy(m.swift));
    }
  }),
  LanguageDescription.of({
    name: "sTeX",
    load() {
      return import("./stex-BU44CCCX.js").then((m) => legacy(m.stex));
    }
  }),
  LanguageDescription.of({
    name: "LaTeX",
  ...
  LanguageDescription.of({
    ...
    extensions: ["v", "sv", "svh"],
    load() {
      return import("./verilog-7LNP7G3B.js").then((m) => legacy(m.verilog));
    }
  }),
  LanguageDescription.of({
    name: "Tcl",
    extensions: ["tcl"],
    load() {
      return import("./tcl-BFNRNCYU.js").then((m) => legacy(m.tcl));
    }
  }),
  LanguageDescription.of({
    name: "Textile",
    extensions: ["textile"],
    load() {
      return import("./textile-KM3CSVY2.js").then((m) => legacy(m.textile));
    }
  }),
  LanguageDescription.of({
    name: "TiddlyWiki",
    load() {
      return import("./tiddlywiki-L5C4UEEN.js").then((m) => legacy(m.tiddlyWiki));
    }
  }),
  LanguageDescription.of({
    name: "Tiki wiki",
    load() {
      return import("./tiki-5ABC75BZ.js").then((m) => legacy(m.tiki));
    }
  }),
  LanguageDescription.of({
    name: "TOML",
    extensions: ["toml"],
    load() {
      return import("./toml-DFMF3QFZ.js").then((m) => legacy(m.toml));
    }
  }),
  LanguageDescription.of({
    name: "Troff",
    ...
    load() {
      return import("./troff-K4KXGIG7.js").then((m) => legacy(m.troff));
    }
  }),
  LanguageDescription.of({
    name: "TTCN",
    ...
    load() {
      return import("./ttcn-4VT6F6RS.js").then((m) => legacy(m.ttcn));
    }
  }),
  LanguageDescription.of({
    name: "TTCN_CFG",
    extensions: ["cfg"],
    load() {
      return import("./ttcn-cfg-D6ZE6TXI.js").then((m) => legacy(m.ttcnCfg));
    }
  }),
  LanguageDescription.of({
    name: "Turtle",
    extensions: ["ttl"],
    load() {
      return import("./turtle-UK6UOZQJ.js").then((m) => legacy(m.turtle));
    }
  }),
  LanguageDescription.of({
    name: "Web IDL",
    extensions: ["webidl"],
    load() {
      return import("./webidl-TYMLXQLN.js").then((m) => legacy(m.webIDL));
    }
  }),
  LanguageDescription.of({
    name: "VB.NET",
    extensions: ["vb"],
    load() {
      return import("./vb-M7322KCB.js").then((m) => legacy(m.vb));
    }
  }),
  LanguageDescription.of({
    name: "VBScript",
    extensions: ["vbs"],
    load() {
      return import("./vbscript-Y3WIBG5I.js").then((m) => legacy(m.vbScript));
    }
  }),
  LanguageDescription.of({
    name: "Velocity",
    extensions: ["vtl"],
    load() {
      return import("./velocity-KAKVXXZN.js").then((m) => legacy(m.velocity));
    }
  }),
  LanguageDescription.of({
    name: "Verilog",
  ...
  LanguageDescription.of({
    ...
    extensions: ["vhd", "vhdl"],
    load() {
      return import("./vhdl-RBJA2BDT.js").then((m) => legacy(m.vhdl));
    }
  }),
  LanguageDescription.of({
    name: "XQuery",
    ...
    load() {
      return import("./xquery-INVEIAOZ.js").then((m) => legacy(m.xQuery));
    }
  }),
  LanguageDescription.of({
    name: "Yacas",
    extensions: ["ys"],
    load() {
      return import("./yacas-YLUIRS4I.js").then((m) => legacy(m.yacas));
    }
  }),
  LanguageDescription.of({
    name: "Z80",
    extensions: ["z80"],
    load() {
      return import("./z80-VC7AEJHW.js").then((m) => legacy(m.z80));
    }
  }),
  LanguageDescription.of({
    name: "MscGen",
    ...
    load() {
      return import("./mscgen-A4LHEXTL.js").then((m) => legacy(m.mscgen));
    }
  }),
  LanguageDescription.of({
    name: "Xù",
    extensions: ["xu"],
    load() {
      return import("./mscgen-A4LHEXTL.js").then((m) => legacy(m.xu));
    }
  }),
  LanguageDescription.of({
    name: "MsGenny",
    extensions: ["msgenny"],
    load() {
      return import("./mscgen-A4LHEXTL.js").then((m) => legacy(m.msgenny));
    }
  }),
  LanguageDescription.of({
    name: "Vue",
    extensions: ["vue"],
    load() {
      return import("./dist-SXJZBJK2.js").then((m) => m.vue());
    }
  }),
  LanguageDescription.of({
    name: "Angular Template",
    load() {
      return import("./dist-VGPDBNPG.js").then((m) => m.angular());
    }
  })
];
